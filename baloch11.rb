      ...
      @email.each do |usr|
        @pool.schedule do
          ...
          if @auto_pass
            ...
            name = usr['name'].split
            (name.length == 1) ? pass = [name.first + '123',name.first + '1234',name.first + '12345',name.first + '786'] : pass = [name.first + '1122',name.last + '12345',name.last + '123',name.last + '1234'] : pass = ['pakistan', 'pakistan123', 'pakistan786', '786786']
